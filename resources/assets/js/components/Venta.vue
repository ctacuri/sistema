          ...
          <div class="card-body">
            ...
            <div class="form-group row border">
              ...
              <div class="col-md-2">
                <div class="form-group">
                  <label>Precio
                    <span style="color:red;" v-show="precio==0">(*Ingrese)</span>
                  </label>
              ...
              <div class="col-md-2">
                <div class="form-group">
                  <label>Cantidad
                    <span style="color:red;" v-show="cantidad==0">(*Ingrese)</span>
                  </label>
                ...
                <table class="table table-bordered table-striped table-sm">
                  ...
                  <tbody v-if="arrayDetalle.length">
                    <tr v-for="(detalle,index) in arrayDetalle" :key="detalle.id">
                      ...
                      <td
                        class="text-right"
                      >{{parseFloat(detalle.precio*detalle.cantidad-detalle.descuento).toFixed(2)}}</td>
                    </tr>
                    <tr style="background-color: #CEECF5;">
                      ...
                      <td
                        class="text-right"
                      >$ {{totalParcial=parseFloat(total-totalImpuesto).toFixed(2)}}</td>
                    </tr>
                    <tr style="background-color: #CEECF5;">
                      <td colspan="5" align="right">
                      ...
                      <td
                        class="text-right"
                      >$ {{totalImpuesto=parseFloat((total*impuesto)/(1+impuesto)).toFixed(2)}}</td>
                    </tr>
                    <tr style="background-color: #CEECF5;">
                      <td colspan="5" align="right">
